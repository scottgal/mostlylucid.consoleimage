...
|:----------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------:|:--------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------:|
| ![ASCII](https://raw.githubusercontent.com/scottgal/mostlylucid.consoleimage/master/samples/boingball_ascii.gif) | ![Blocks](https://raw.githubusercontent.com/scottgal/mostlylucid.consoleimage/master/samples/boingball_blocks.gif) | ![Braille](https://raw.githubusercontent.com/scottgal/mostlylucid.consoleimage/master/samples/boingball_braille.gif) | ![Matrix](https://raw.githubusercontent.com/scottgal/mostlylucid.consoleimage/master/samples/landscape_matrix.gif) |
